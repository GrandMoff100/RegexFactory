...
WHITESPACE = CharClass(r"\s", _precedence=10)
...
NOTWHITESPACE = CharClass(r"\S", _precedence=10)
...
WORD = CharClass(r"\w", _precedence=10)
...
NOTWORD = CharClass(r"\W", _precedence=10)
...
DIGIT = CharClass(r"\d", _precedence=10)
...
NOTDIGIT = CharClass(r"\D", _precedence=10)
