...
ANCHOR_START = RegexPattern(r"^", _precedence=-1)
...
ANCHOR_END = RegexPattern(r"$", _precedence=-1)
...
WHITESPACE = RegexPattern(r"\s", _precedence=10)
...
NOTWHITESPACE = RegexPattern(r"\S", _precedence=10)
...
WORD = RegexPattern(r"\w", _precedence=10)
...
NOTWORD = RegexPattern(r"\W", _precedence=10)
...
DIGIT = RegexPattern(r"\d", _precedence=10)
...
NOTDIGIT = RegexPattern(r"\D", _precedence=10)
